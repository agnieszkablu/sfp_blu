...
<div id="page" class="site">
	<div class="container">
		<div class="row" >
			<!-- <div class="col-xs-12 hidden-xs flagContainer">
			<?php // wp_nav_menu(array('menu'=>'language-switching')); ?>
			</div> -->
			<div class="col-xs-12 minuspaddingContainer">
					...
					<nav id="site-navigation" class="main-navigation navbar navbar-default" role="navigation">
						<div class="container-fluid">
						  <div class="navbar-header">
							...
							<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt="Logo image sfp"></a>
							<!-- <div class="hidden-sm hidden-md  hidden-lg flagContainer">
								<?php // wp_nav_menu(array('menu'=>'language-switching')); ?>
							</div> -->
						  </div>
